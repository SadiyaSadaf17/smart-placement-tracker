...
const placementDriveSchema = new mongoose.Schema(
  {
    ...
    eligibility: {
      ...
      minimumTenthPercentage: { type: Number, default: 0, min: 0, max: 100 },
      minimumTwelfthPercentage: { type: Number, default: 0, min: 0, max: 100 },
      minimumGraduationPercentage: { type: Number, default: 0, min: 0, max: 100 },
      minimumATSScore: { type: Number, default: 0, min: 0, max: 100 },
      allowedBranches: {
        type: [String],
      ...
      maximumBacklogs: { type: Number, default: 0, min: 0 },
    },
